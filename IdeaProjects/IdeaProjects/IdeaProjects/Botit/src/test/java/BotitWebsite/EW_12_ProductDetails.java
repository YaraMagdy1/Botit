...
public class EW_12_ProductDetails extends BaseWebsite {
   ...
   //----------------From The Home Page----------------
    ...
    @Test(priority = 2)
    //GC02 || SIT || Check Product details page design and information
    public void CheckDetailsAtProductDetailsPage() throws InterruptedException {
        Common_Methods.scrolling("/html/body/div[6]/div/div");
        Product_Details.CheckTheFooter();
        Common_Methods.Screenshot("EW 12 GC02 Step8 Check design for footer");
